window.onload = function() {
    ...
    function fetchSldData() {
        fetch('/fetch_data/') // Fetch data from the endpoint
            ...
            .then(data => {                
                ...
                // console.log("Updated pythonData:", pythonData); // Log the value when it is fetched

                pythonData = data.final_data // Assign the value to the global variable
                ...
                console.log("Data:", typeof(pythonData));
                ...
                const config = {
                    ...
                    feederNames: [
                        [{ feederName : "Feeder A"}, { feederName : "DUMMY"},{ feederName : "Feeder C"}, { feederName : "Feeder D"}, { feederName : "Feeder E"}],
    ...
    // var data = pythonData;
    console.log("1",pythonData)
    setInterval(fetchSldData, 1000);

    // setTimeout(() => {
    //     console.log("Accessed pythonData after delay:", pythonData);
    // }, 2000); // Wait for at least one fetch cycle to complete
    // console.log("Accessed pythonData :", pythonData);
