                        ...
                        for (let j = 0; j < new_feederCount; j++) {
                            ...
                            for (let i = 0; i < feederNames.length; i++) {
                                ...
                                for (let j = 0; j < group.length; j++) {
                                    ...
                                    let feederData = {
                                        V: matchedFeeder ? matchedFeeder["R_VOLT"] ?? "N/A" : "N/A",
                                        I: matchedFeeder ? matchedFeeder["R_CURR"] ?? "N/A" : "N/A",
                                        MW: matchedFeeder ? matchedFeeder["Y_CURR"] ?? "N/A" : "N/A",
                                        MVAR: matchedFeeder ? matchedFeeder["ACTIVE_IMPORT_ENERGY"] ?? "N/A" : "N/A",
                                        PF: matchedFeeder ? matchedFeeder["PF_R"] ?? "N/A" : "N/A"
                                    };
