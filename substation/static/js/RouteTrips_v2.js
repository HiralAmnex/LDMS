        ...
        for (let i = 0; i < transformerCount; i++) {
           ...
           const combinedDashArray =
            ...
            for(let i = 0; i < feederCount; i++){
                ...
                const outgoingFeederData = data.feeder[i]; // Use `j` as the index to access each feeder
                ...
                console.log(`Feeder ${i + 1} Data: `, ogfeederData[i]);
                ...
                outGoingFeederCBDataHeaders.forEach((header, index) => {
                    ...
                    if (!svg.querySelector(`#${valueTextId}`)) {
                        const valueText = createTextElement(
                            feederX - 55,
                            rowY,
                            ogfeederData[j] ? ogfeederData[j][header] : "N/A",
                            "13px",
                            "black"
                        );
